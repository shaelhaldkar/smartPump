...
public class StorageUtils {
    ...
    public static String createExternalDirectory() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            File baseDirFile = MainApplication.Companion.getInstance().getExternalFilesDir(Environment.DIRECTORY_PICTURES);
            if (baseDirFile != null) {
                baseDir = baseDirFile.getAbsolutePath();
            }
        }
        if (baseDir == null) {
            baseDir = MainApplication.Companion.getInstance().getFilesDir().getAbsolutePath();
        }
        return baseDir;
    }

    public static String createInternalDirectory() {
        return MainApplication.Companion.getInstance().getFilesDir().getAbsolutePath();
    }
